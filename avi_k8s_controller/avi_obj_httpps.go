...
func AviHttpPSBuild(hps_meta *AviHttpPolicySetMeta) *RestOp {
    name := hps_meta.Name
    ...
    macro := AviRestObjMacro{ModelName: "HTTPRequestPolicy", Data: hps}
    ...
    AviLog.Info.Print(spew.Sprintf("HTTPRequestPolicy Restop %v AviHttpPolicySetMeta %v\n", 
                                   rest_op, *hps_meta))
    return &rest_op
}
