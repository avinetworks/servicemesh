...
func AviPoolCacheAdd(pool_cache *utils.AviCache, rest_op *RestOp) error {
...
func AviPoolCacheDel(pool_cache *utils.AviCache, key NamespaceName) {
	pool_cache.AviCacheDelete(key)
}

func AviSvcToPoolCacheAdd(svc_to_pool_cache *utils.AviMultiCache, rest_op *RestOp,
